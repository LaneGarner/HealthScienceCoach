...
export const About = () => {
  return (
    <div className="page-container about-page">
      {/* <img src="https://healthsciencecoach.com/img/hirepaths_blog-images_health-career-podcast.png" alt="Drew Garner hosting health science coach podcast with yellow geometric design in background" /> */}
      ...
      {/* <iframe src="https://outlook.office365.com/owa/calendar/HealthScienceCoachPodcast@turnerusd202.org/bookings/" width="100%" height="100%" scrolling="yes" style={{border:0}}></iframe> */}
    </div>
  );
};
